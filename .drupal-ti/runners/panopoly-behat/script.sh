...
then
	...
	DRUSH_ARGS="--root=$DRUPAL_TI_DRUPAL_DIR/web --uri=$DRUPAL_TI_WEBSERVER_URL:$DRUPAL_TI_WEBSERVER_PORT" "$TRAVIS_BUILD_DIR"/vendor/bin/robo check:overridden
fi
...
BEHAT="$TRAVIS_BUILD_DIR/vendor/bin/behat"
